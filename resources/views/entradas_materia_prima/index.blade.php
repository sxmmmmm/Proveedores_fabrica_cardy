        ...
        <div class="bg-white shadow rounded overflow-x-auto">
            <table style="border-color: #F4A7B9;" class="w-full text-center border border-gray-300 text-sm">
                ...
                <tbody>
                    @forelse($entradas as $entrada)
                        <tr onmouseover="this.style.backgroundColor='#FCE4EC'"
                            ...
                            <td class="px-3 py-2 border">
                                ...
                                @else
                                    <span class="text-gray-400 italic">{{ $entrada->usuario_nombre ?? 'N/A' }}</span>
                                @endif
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="p-6 text-gray-500">No hay entradas registradas</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
