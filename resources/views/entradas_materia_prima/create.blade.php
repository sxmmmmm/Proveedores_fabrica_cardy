<x-with-sidebar-layout>
    ...
    <x-slot name="pageTitle">Nueva Entrada de Materia Prima</x-slot>
    <x-slot name="header">Entradas de Materia Prima</x-slot>

    <div class="p-6 max-w-2xl mx-auto">
        <div class="bg-white shadow rounded-lg overflow-hidden">

            <div class="px-6 py-4" style="background: linear-gradient(to right, #4DC9C2, #3db5ae);">
                <h3 class="text-lg font-bold text-white">Registrar Nueva Entrada</h3>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('entradas-materia-prima.store') }}" method="POST" class="space-y-4">
                    @csrf
