                ...
                <tbody>
                    @forelse($salidas as $salida)
                        <tr onmouseover="this.style.backgroundColor='#FCE4EC'"
                            ...
                            <td class="p-3 border">{{ $salida->producto->nombre ?? 'N/A' }}</td>
                            <td class="p-3 border">{{ $salida->cliente->nombre ?? 'N/A' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="p-4 text-gray-500">No hay salidas registradas</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
