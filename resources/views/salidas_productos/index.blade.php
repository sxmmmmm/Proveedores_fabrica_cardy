<x-with-sidebar-layout>
    ...
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('salidas-productos.create') }}"
            ...
            <table style="border-color: #F4A7B9;" class="w-full text-center border border-gray-300 text-sm">
                <thead>
                    <tr style="background-color: #F4A7B9;">
                        ...
                        <th class="px-3 py-2 border text-white font-semibold">Producto</th>
                        <th class="px-3 py-2 border text-white font-semibold">Cliente</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="p-6 text-gray-500">No hay salidas registradas</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
